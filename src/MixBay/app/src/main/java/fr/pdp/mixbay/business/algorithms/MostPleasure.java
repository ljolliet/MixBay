...
public class MostPleasure extends AlgoSuperclass {
     ...
     * The music score of a track for the group is the highest score of all
     * the users (Most Pleasure Strategy).
     * The 25 tracks with the lowest distance are chosen to be part of the
     * locale playlist.
     *
    ...
    public LocalPlaylist computeLocalePlaylist(Map<String,
        ...
        Iterator computedTracksIterator = MostPleasureComputed.entrySet()
                                                              .iterator();
        int index = 0;
